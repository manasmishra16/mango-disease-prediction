...
export function Sidebar() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 border-b border-[var(--border-subtle)] px-4 py-5">
      ...
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 10 }}
            className="mx-3 mb-4 rounded-xl border border-green-500/20 bg-green-500/6 p-3"
          >
